CREATE DATABASE  IF NOT EXISTS `enc_n_dec` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `enc_n_dec`;
...
--
-- Table structure for table `blowfish_details`
--

DROP TABLE IF EXISTS `blowfish_details`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `blowfish_details` (
...
--
-- Dumping data for table `blowfish_details`
--

LOCK TABLES `blowfish_details` WRITE;
/*!40000 ALTER TABLE `blowfish_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `blowfish_details` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-12-06 17:38:54
