...
public class MainPage extends javax.swing.JFrame {
   ...
   public MainPage(String user_id) {
    ...
    void encrypt_blowFish()
    {
        ...
        String key = obj.getAlphaString();
        String encryptedString = "";
        
        try{
            encryptedString = obj.encrypt(plainText, key);
        } catch(Exception ex){
...
//        String secretKey = String.valueOf(key);
        ...
        String sql2="insert into blowfish_details (file_name,secretKey) values (?,?)";
        try{
   ...
   void decrypt_blowFish()
   {
       try{
        ...
        String sql="select * from blowfish_details where file_name=?";
        try{
        ...
        Encrypt_Decrypt_Blowfish obj = new Encrypt_Decrypt_Blowfish();
        String decryptedString = obj.decrypt(encText, key);
